<?php    
    ...
    for($ctr=0;$ctr<$rows_found;$ctr++){
        $detail[$ctr]["sCntryCde"] = mb_convert_encoding($rows[$ctr]["sCntryCde"], 'UTF-8', 'ISO-8859-1');
        $detail[$ctr]["sCntryNme"] = mb_convert_encoding($rows[$ctr]["sCntryNme"], 'UTF-8', 'ISO-8859-1');
        $detail[$ctr]["sNational"] = mb_convert_encoding($rows[$ctr]["sNational"], 'UTF-8', 'ISO-8859-1');
