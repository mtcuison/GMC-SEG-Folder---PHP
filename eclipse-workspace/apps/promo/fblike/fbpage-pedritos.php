...
if ($division != "4") showMessage("This page is not suitable for your reference number. Thank you for your attempt.");
...
<head>
    ...
    <style>
        ...
        .menu-bg {
            background-image: url("../images/pedritos header 2.png");
            height: 65px;
        ...
        .body-bg {
            background-image: url("../images/pedritos bg.png");
            height: 100%;
