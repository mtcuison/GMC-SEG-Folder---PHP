...
if ($division != "0") showMessage("This page is not suitable for your reference number. Thank you for your attempt.");
...
<head>
	...
	<title>Guanzon - Mobile Phone</title>
    ...
    <style>
        ...
        .body-bg {
            background-image: url("../images/guanzon-mp bg.png");
            height: 100%;
