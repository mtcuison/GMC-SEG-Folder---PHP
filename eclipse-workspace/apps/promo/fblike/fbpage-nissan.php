...
if ($division != "5") showMessage("This page is not suitable for your reference number. Thank you for your attempt.");
...
<head>
    ...
    <style>
        ...
        .menu-bg {
            background-image: url("../images/nissan header.png");
            height: 65px;
