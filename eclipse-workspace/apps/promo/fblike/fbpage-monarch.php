...
if ($division != "3") showMessage("This page is not suitable for your reference number. Thank you for your attempt.");
...
<head>
    ...
    <style>
        ...
        .menu-bg {
            background-image: url("../images/monarch header.png");
            height: 65px;
        ...
        .body-bg {
            background-image: url("../images/monarch bg.png");
            height: 100%;
