...
if ($division != "6") showMessage("This page is not suitable for your reference number. Thank you for your attempt.");
...
<head>
	...
	<title>Honda Cars Pangasinan</title>
    ...
    <style>
        ...
        .menu-bg {
            background-image: url("../images/honda header.png");
            height: 65px;
        ...
        .body-bg {
            background-image: url("../images/honda bg.png");
            height: 100%;
            background-repeat: no-repeat;
            background-size: cover;
        }
