...
//if($logno == "XNOLOGX"){
//    $aes = new MySQLAESNew();
//    $userid		= $aes->decrypt($myheader['g-api-user'], $myheader['g-api-imei']) ;
//    //if we want to use the info the user then try to decrypt here...    
//    if(!$app->loaduser($prodctid, $userid, $pcname, $clientid)){
//        $json["result"] = "error";
//        $json["error"]["message"] = "Invalid USER ID detected... " + $app->getErrorMessage();
//        echo json_encode($json);
//       return;
//    }
//}
