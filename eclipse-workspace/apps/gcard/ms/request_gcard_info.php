...
$json["sNmOnCard"] = mb_convert_encoding($rows[0]["sNmOnCard"], 'UTF-8', 'ISO-8859-1');
$json["sClientID"] = $rows[0]["sClientID"];
$json["sCompnyNm"] = mb_convert_encoding($rows[0]["sCompnyNm"], 'UTF-8', 'ISO-8859-1');
$json["sAddressx"] = mb_convert_encoding($rows[0]["sAddressx"], 'UTF-8', 'ISO-8859-1');
$json["sBirthPlc"] = mb_convert_encoding($rows[0]["sBirthPlc"], 'UTF-8', 'ISO-8859-1');
