...
for($ctr=0;$ctr<$rows_found;$ctr++){
    $detail[$ctr]["sBranchCD"] = htmlspecialchars($rows[$ctr]["sBranchCD"]);
    $detail[$ctr]["sBranchNm"] = htmlspecialchars($rows[$ctr]["sBranchNm"]);
    $detail[$ctr]["sDescript"] = htmlspecialchars($rows[$ctr]["sDescript"]);
    $detail[$ctr]["sAddressx"] = htmlspecialchars($rows[$ctr]["sAddressx"]);
    $detail[$ctr]["sTelNumbr"] = htmlspecialchars($rows[$ctr]["sTelNumbr"]);
    $detail[$ctr]["sContactx"] = htmlspecialchars($rows[$ctr]["sContactx"]);
    $detail[$ctr]["sEMailAdd"] = htmlspecialchars($rows[$ctr]["sEMailAdd"]);
}
