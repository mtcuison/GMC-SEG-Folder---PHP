<?php 
//query/client/get_reg_client.php
...
$sql = "SELECT" .
            ...
            ", f.nLastPaym" .
            ", f.dLastPaym" .
            ", IFNULL(e.nLongitud, 0) nLongitud" .
            ", IFNULL(e.nLatitude, 0) nLatitude" .
        " FROM MC_Serial a" .
                " LEFT JOIN MC_AR_Master f" .
            ...
            ", Client_Master b" .
                ...
                " LEFT JOIN Client_Coordinates e" .
                    " ON b.sClientID = e.sClientID" .
        " WHERE a.sClientID = b.sClientID";

if ($bycode == true){
    $sql = CommonUtil::addcondition($sql, "a.sEngineNo = " . CommonUtil::toSQL($value));
} else {
...
for($ctr=0; $ctr<$rows_found; $ctr++){
    ...
    $detail[$ctr]["sAcctNmbr"] = null;
    $detail[$ctr]["dDueDatex"] = null;
    $detail[$ctr]["nMonAmort"] = null;
    $detail[$ctr]["nAmtDuexx"] = null;
    $detail[$ctr]["nABalance"] = null;
    $detail[$ctr]["nDelayAvg"] = null;
    $detail[$ctr]["nLastPaym"] = null;
    $detail[$ctr]["dLastPaym"] = null;
